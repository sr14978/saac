...
public class Instruction {
	enum Opcode {Nop, Ldc, Add, Addi, Sub, Subi, Mul, Muli, Div, Divi}
	static Map<Opcode, Integer> InstructionDelay = new HashMap<Opcode, Integer>(){{
		put(Opcode.Nop, 0); put(Opcode.Ldc, 0);
		put(Opcode.Add, 0); put(Opcode.Addi, 0);
		put(Opcode.Sub, 0); put(Opcode.Subi, 0);
